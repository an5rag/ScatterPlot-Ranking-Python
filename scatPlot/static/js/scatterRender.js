...
function showScatterPlot(data) {
    ...
    var svg = d3.select("#scatter-load").append("svg").attr("width", width+20).attr("height", height+20).style("border", "1px solid black").style("display", "block").style("margin", "auto").style("padding", "auto").append("g")
